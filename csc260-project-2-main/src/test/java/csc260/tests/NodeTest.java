...
///**
// * Tests for classBoxNode
// * **/
//
//public class NodeTest
//{
//    private ClassBoxNode n;
//    private ClassBoxNode nTwo;
...
//        n = new ClassBoxNode("TestClass");
//        nTwo = new ClassBoxNode("TestClassTwo", coords);
//    }
//
//    @After
...
//
//    @Test
//    public void testAddInstVar()
//    {
//        assertEquals("New classbox has header", false, n.isEmpty());
//        assertEquals("New classbox header is passed", "TestClass", n.getHeader());
//        n.addInstVar("intA");
//        assertEquals("There is an instance variable in the class, so it is not empty. ", false, n.getAttributes().isEmpty());
//        n.clearBody();
//        assertEquals("checking if there is an A after removing A gives nothing", true, n.getAttributes()==null);
//    }
//
//    @Test
...
//        Point2D newCoordTwo = new Point2D.Double(-0.5,0.6666);
...
//        methodList.add(m);
//
//        assertEquals("Node n has the same number of methods in the same order as method list",methodList,n.getMethods());
//
//    }
//
//    @Test
...
//
//        assertEquals("Type of node n is classBox which is 0 according to NodesConfig",0,n.getType());
//        assertEquals("Type of node nTwo is classBox which is 0 according to NodesConfig",0,nTwo.getType());
//
//    }
//
//
...
//        Point2D nIncomingEdgeCoord = new Point2D.Double(0,-60);
...
//
//        Point2D nTwoIncomingEdgeCoord = new Point2D.Double(1,-58);
...
//        Point2D newIncomingEdgeCoord = new Point2D.Double(-1,-62);
...
//        Point2D newIncomingEdgeCoordTwo = new Point2D.Double(3.5,-62.22);
...
//        Point2D nOutgoingEdgeCoord = new Point2D.Double(150,-60);
...
//
//        Point2D nTwoOutgoingEdgeCoord = new Point2D.Double(151,-58);
...
//
//        n.setUpperLeftCoord(-1,-2);
//        Point2D newOutgoingEdgeCoord = new Point2D.Double(149,-62);
...
//
//        nTwo.setUpperLeftCoord(3.5,-2.22);
//        Point2D newOutgoingEdgeCoordTwo = new Point2D.Double(153.5,-62.22);
...
//        assertEquals("Node n has empty method",null,n.getMethods());
//        assertEquals("Node n has empty attributes",null,n.getAttributes());
//
//
//    }
//
...
//
//        n.addInstVar("ClassBoxNode");
//        assertEquals("Node n is not empty",false,n.isEmpty());
//
...
//        n.addInstVar("attributes");
//        n.addInstVar(0,"anotherAttributes");
//        ArrayList<String> attributesList = new ArrayList<>();
//        attributesList.add("anotherAttributes");
//        attributesList.add("attributes");
//
//        assertEquals("Node n has the same attributes as attributes list",attributesList, n.getAttributes());
//
//    }
//
//    @Test
...
//        contentsList.add(attributesList);
//        contentsList.add(methodsList);
//
